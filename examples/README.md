...
- [Получение сообщений](chat.ts)
- [Получение сообщений (стримингом)](stream.ts)
- [Получение сообщений (стримингом через events)](stream_events.ts)
- [Генерация изображений](generate_image.ts)
- [Чат-бот](chat_bot.ts)
- [Работа с GigaChat Vision](vision.ts)
- [Работа с Embeddings](embeddings.ts)
- [Чат-бот с функциями (продуктовый помощник)](chat_bot_with_functions.ts)
